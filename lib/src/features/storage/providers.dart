...
final storageProductsFilterProvider = StateProvider.autoDispose.family<StorageProductsFilter, String>((ref, storageUuid) {
  return StorageProductsFilter(storageUuid: storageUuid);
});
